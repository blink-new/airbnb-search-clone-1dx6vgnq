...
type ViewType = 'homepage' | 'search' | 'list-space' | 'storage-details' | 'booking-confirmation' | 'booking-success'
...
function App() {
  ...
  const handleListSpace = async (spaceData: any) => {
    try {
      ...
      alert('Storage space listed successfully!')
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <p className="text-gray-600 mb-8">
            Your storage space has been reserved. You'll receive a confirmation email shortly.
          </p>
          <Button 
            onClick={() => {
